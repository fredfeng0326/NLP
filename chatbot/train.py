...
def tests(params):
    from chatbot.sequence_to_sequence import SequenceToSequence
    from chatbot.data_utils import batch_flow_bucket as batch_flow
    from chatbot.threadedgenerator import ThreadedGenerator
